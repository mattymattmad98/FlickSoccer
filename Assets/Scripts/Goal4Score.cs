...
public class Goal4Score : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        GoalBounceOn = GameObject.Find("GoalB4");
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        GameObject.Find("Goal1").GetComponent<Goal1Score>().scored_onGoal = 4;
        GameObject.Find("Goal2").GetComponent<Goal2Score>().scored_onGoal = 4;
        GameObject.Find("Goal3").GetComponent<Goal3Score>().scored_onGoal = 4;
        GameObject.Find("Goal4").GetComponent<Goal4Score>().scored_onGoal = 4;
        GameObject.Find("Goal5").GetComponent<Goal5Score>().scored_onGoal = 4;
        GameObject.Find("Goal6").GetComponent<Goal6Score>().scored_onGoal = 4;
        ...
        else if (Goals4 == 1)
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone1[i + 16] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone2[i + 14] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone3[i + 16] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone5[i + 23] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone6[i + 23] = 0;
            }
            ...
            if (GameObject.Find("BinhoBall").GetComponent<AIShoot>().keepGoals == 0)
            {
                for (int i = 0; i < 7; i++)
                {
                    GameObject.Find("Main Camera").GetComponent<PegRemoval>().totalActivePegs[i + 21].SetActive(false);
                }
            }
            GoalBounceOn.gameObject.SetActive(true);
            GameObject.Find("BinhoBall").GetComponent<AIShoot>().goalOn[3] = 0;
            GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient = GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient + "4";
        ...
        // + Goals4 + " to " + GameObject.Find("Goal5").GetComponent<Goal5Score>().Goals5 + " to " + GameObject.Find("Goal6").GetComponent<Goal6Score>().Goals6);
        ...
        if (GameObject.Find("BinhoBall").GetComponent<playerController>().numPlayers == 1)
        {
            ...
            string txtSave =
                ...
                GameObject.Find("Goal4").GetComponent<Goal4Score>().Goals + ", " + GameObject.Find("BinhoBall").GetComponent<AIShoot>().totShots + ", " +
