...
public class Goal3Score : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        GoalBounceOn = GameObject.Find("GoalB3");
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        GameObject.Find("Goal1").GetComponent<Goal1Score>().scored_onGoal = 3;
        GameObject.Find("Goal2").GetComponent<Goal2Score>().scored_onGoal = 3;
        GameObject.Find("Goal3").GetComponent<Goal3Score>().scored_onGoal = 3;
        GameObject.Find("Goal4").GetComponent<Goal4Score>().scored_onGoal = 3;
        GameObject.Find("Goal5").GetComponent<Goal5Score>().scored_onGoal = 3;
        GameObject.Find("Goal6").GetComponent<Goal6Score>().scored_onGoal = 3;
        ...
        else if (Goals3==1)
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone1[i + 9] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone2[i + 7] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone4[i + 16] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone5[i + 16] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone6[i + 16] = 0;
            }
            ...
            if (GameObject.Find("BinhoBall").GetComponent<AIShoot>().keepGoals == 0)
            {
                for (int i = 0; i < 7; i++)
                {
                    GameObject.Find("Main Camera").GetComponent<PegRemoval>().totalActivePegs[i + 14].SetActive(false);
                }
            }
            GoalBounceOn.gameObject.SetActive(true);
            GameObject.Find("BinhoBall").GetComponent<AIShoot>().goalOn[2] = 0;
            GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient = GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient + "3";


        }
        //Debug.Log("Score: " + GameObject.Find("Goal1").GetComponent<Goal1Score>().Goals1 + " to " +
        //  GameObject.Find("Goal2").GetComponent<Goal2Score>().Goals2 + " to " + Goals3 + " to " + GameObject.Find("Goal4").GetComponent<Goal4Score>().Goals4 + " to "
        ...
        if (GameObject.Find("BinhoBall").GetComponent<playerController>().numPlayers == 1)
        {
            ...
            string txtSave = 
                ...
                GameObject.Find("Goal3").GetComponent<Goal3Score>().Goals + ", " + GameObject.Find("BinhoBall").GetComponent<AIShoot>().totShots + ", " +
