...
public class Goal1Score : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        GoalBounceOn = GameObject.Find("GoalB1");
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        GameObject.Find("Goal1").GetComponent<Goal1Score>().scored_onGoal = 1;
        GameObject.Find("Goal2").GetComponent<Goal2Score>().scored_onGoal = 1;
        GameObject.Find("Goal3").GetComponent<Goal3Score>().scored_onGoal = 1;
        GameObject.Find("Goal4").GetComponent<Goal4Score>().scored_onGoal = 1;
        GameObject.Find("Goal5").GetComponent<Goal5Score>().scored_onGoal = 1;
        GameObject.Find("Goal6").GetComponent<Goal6Score>().scored_onGoal = 1;
        ...
        else if (Goals1 == 1)
        {
            ...
            {
                //Debug.Log("Resetting");
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone2[i] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone3[i] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone4[i] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone5[i] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone6[i] = 0;
            }
           ...
           //works
            if (GameObject.Find("BinhoBall").GetComponent<AIShoot>().keepGoals == 0)
            {
                for (int i = 0; i < 7; i++)
                {
                    GameObject.Find("Main Camera").GetComponent<PegRemoval>().totalActivePegs[i].SetActive(false);
                }
                
            }

            GameObject.Find("BinhoBall").GetComponent<AIShoot>().goalOn[0] = 0;
            GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient = GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient + "1";

            GoalBounceOn.gameObject.SetActive(true);

        }

        //Debug.Log("Score: " + Goals1 + " to " + GameObject.Find("Goal2").GetComponent<Goal2Score>().Goals2 + " to "
        ...
        if (GameObject.Find("BinhoBall").GetComponent<playerController>().numPlayers == 1)
        {
            ...
            {
                System.IO.File.WriteAllText(filePath, "Goal1, Goal2, Goal3, Goal4, Goal5, Goal6, Winner, Knockout Order, G1Scored, G2Scored, G3Scored, G4Scored, G5Scored, G6Scored, Goals Left, Total Shots, Shot Dist, XCoord, YCoord \n\n");
            }
            string txtSave =
                ...
                GameObject.Find("Goal1").GetComponent<Goal1Score>().Goals + ", " + GameObject.Find("BinhoBall").GetComponent<AIShoot>().totShots + ", " +
            ...
            //maybe do reset option instead
            //track wins by pegs ON/OFF
        }
    }
