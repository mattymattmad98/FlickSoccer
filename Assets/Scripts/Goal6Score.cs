...
public class Goal6Score : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        GoalBounceOn = GameObject.Find("GoalB6");
    ...
    //If all other goals also equal zeros - the one alive one declared winner
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        GameObject.Find("Goal1").GetComponent<Goal1Score>().scored_onGoal = 6;
        GameObject.Find("Goal2").GetComponent<Goal2Score>().scored_onGoal = 6;
        GameObject.Find("Goal3").GetComponent<Goal3Score>().scored_onGoal = 6;
        GameObject.Find("Goal4").GetComponent<Goal4Score>().scored_onGoal = 6;
        GameObject.Find("Goal5").GetComponent<Goal5Score>().scored_onGoal = 6;
        GameObject.Find("Goal6").GetComponent<Goal6Score>().scored_onGoal = 6;
        ...
        else if (Goals6 == 1)
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone1[i + 32] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone2[i + 30] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone3[i + 32] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone4[i + 32] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone5[i + 30] = 0;
            }
            ...
            if (GameObject.Find("BinhoBall").GetComponent<AIShoot>().keepGoals == 0)
            {
                for (int i = 0; i < 7; i++)
                {
                    GameObject.Find("Main Camera").GetComponent<PegRemoval>().totalActivePegs[i + 35].SetActive(false);
                }
            }
            GoalBounceOn.gameObject.SetActive(true);
            GameObject.Find("BinhoBall").GetComponent<AIShoot>().goalOn[5] = 0;
            GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient = GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient + "6";
        ...
        // + GameObject.Find("Goal4").GetComponent<Goal4Score>().Goals4 + " to " + GameObject.Find("Goal5").GetComponent<Goal5Score>().Goals5 + " to " + Goals6);
        ...
        if (GameObject.Find("BinhoBall").GetComponent<playerController>().numPlayers == 1)
        {
            ...
            string txtSave =
                ...
                GameObject.Find("Goal6").GetComponent<Goal6Score>().Goals + ", " + GameObject.Find("BinhoBall").GetComponent<AIShoot>().totShots + ", " +
