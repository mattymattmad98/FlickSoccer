...
public class Goal2Score : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        GoalBounceOn = GameObject.Find("GoalB2");
...
//need a solid for bringing score down per side
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        GameObject.Find("Goal1").GetComponent<Goal1Score>().scored_onGoal = 2;
        GameObject.Find("Goal2").GetComponent<Goal2Score>().scored_onGoal = 2;
        GameObject.Find("Goal3").GetComponent<Goal3Score>().scored_onGoal = 2;
        GameObject.Find("Goal4").GetComponent<Goal4Score>().scored_onGoal = 2;
        GameObject.Find("Goal5").GetComponent<Goal5Score>().scored_onGoal = 2;
        GameObject.Find("Goal6").GetComponent<Goal6Score>().scored_onGoal = 2;
        ...
        else if (Goals2 ==1)
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone1[i] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone3[i + 7] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone4[i + 7] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone5[i + 7] = 0;
                GameObject.Find("Main Camera").GetComponent<buildGoalArrs>().shotGoodZone6[i + 7] = 0;
            }
            ...
            if (GameObject.Find("BinhoBall").GetComponent<AIShoot>().keepGoals == 0)
            {
                for (int i = 0; i < 7; i++)
                {
                    GameObject.Find("Main Camera").GetComponent<PegRemoval>().totalActivePegs[i + 7].SetActive(false);
                }
            }
            GoalBounceOn.gameObject.SetActive(true);
            GameObject.Find("BinhoBall").GetComponent<AIShoot>().goalOn[1] = 0;
            GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient = GameObject.Find("Main Camera").GetComponent<PegRemoval>().winOrient + "2";


        }

        //  Debug.Log("Score: " + GameObject.Find("Goal1").GetComponent<Goal1Score>().Goals1 + " to " + Goals2 + " to "
        //    + GameObject.Find("Goal3").GetComponent<Goal3Score>().Goals3 + " to " + GameObject.Find("Goal4").GetComponent<Goal4Score>().Goals4 + " to "
        //  + GameObject.Find("Goal5").GetComponent<Goal5Score>().Goals5 + " to " + GameObject.Find("Goal6").GetComponent<Goal6Score>().Goals6);
        ...
        if (GameObject.Find("BinhoBall").GetComponent<playerController>().numPlayers == 1)
        {
            ...
            if (GameObject.Find("Goal1").GetComponent<Goal1Score>().Goals1 != 0) { GameObject.Find("Main Camera").GetComponent<PegRemoval>().gameWinners[GameObject.Find("Main Camera").GetComponent<PegRemoval>().numReset] = GameObject.Find("Main Camera").GetComponent<PegRemoval>().goal1; GameObject.Find("Main Camera").GetComponent<PegRemoval>().gameWinner = 1; }
            ...
            else if (GameObject.Find("Goal5").GetComponent<Goal5Score>().Goals5 != 0) { GameObject.Find("Main Camera").GetComponent<PegRemoval>().gameWinners[GameObject.Find("Main Camera").GetComponent<PegRemoval>().numReset] = GameObject.Find("Main Camera").GetComponent<PegRemoval>().goal5; GameObject.Find("Main Camera").GetComponent<PegRemoval>().gameWinner = 5; }
            ...
            string txtSave =
                ...
                GameObject.Find("Goal2").GetComponent<Goal2Score>().Goals + ", " + GameObject.Find("BinhoBall").GetComponent<AIShoot>().totShots + ", " +
